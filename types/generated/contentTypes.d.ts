...
export interface ApiIntroIntro extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    biography_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    biography_title: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::intro.intro'> &
      Schema.Attribute.Private;
    personal_history: Schema.Attribute.Text;
    personal_history_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    personal_history_title: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
